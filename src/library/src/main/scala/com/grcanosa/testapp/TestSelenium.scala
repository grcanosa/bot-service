...
import org.openqa.selenium.{By, Capabilities, Keys, Platform, WebElement}
import org.openqa.selenium.remote.{BrowserType, CommandExecutor}
...
object TestSelenium extends App {
